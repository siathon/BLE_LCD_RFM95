...
#define MBED_CONF_APP_LORA_SPI_MISO                                           p21                                                                                                // set by application[NRF51_DK]
#define MBED_CONF_APP_LORA_SPI_MOSI                                           p23                                                                                                // set by application[NRF51_DK]
#define MBED_CONF_APP_LORA_SPI_SCLK                                           p25                                                                                                // set by application[NRF51_DK]
#define MBED_CONF_APP_LORA_TCXO                                               NC                                                                                                 // set by application[NRF51_DK]
#define MBED_CONF_APP_LORA_TXCTL                                              NC                                                                                                 // set by application[NRF51_DK]
...
#define MBED_CONF_LORA_APPLICATION_EUI                                        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } // set by application[*]
#define MBED_CONF_LORA_APPLICATION_KEY                                        { 0x97, 0xB1, 0xaF, 0x77, 0xC4, 0xCB, 0x6A, 0x1C, 0x6E, 0xF3, 0xE9, 0x3B, 0x6A, 0xEA, 0x76, 0x70 } // set by application[*]
...
#define MBED_CONF_SX1276_LORA_DRIVER_RADIO_VARIANT                            0                                                                                                  // set by library:sx1276-lora-driver
